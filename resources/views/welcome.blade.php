    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="{{ asset('images/uhub-logo.png') }}" alt="logo" width="200px" />
            </div>
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">User friendly</h2>
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Library</h2>
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Counseling Hour</h2>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    <img src="{{ asset('images/uhub-logo.png') }}" alt="logo" width="100px" />
                </div>
            </div>
        </div>
    </div>

        ...
        <div class="grid grid-cols-4 gap-12 m-1">
            ...
            <button class="" onclick="my_modal_1.showModal()">
                <div class="card card-compact  bg-base-100 shadow-orange-500 shadow-sm">
                    <figure><img src="{{ url('uploads/book_images/Introduction-to-Algorithms.jpg') }}"
                            alt="Intro to Algorithms" /></figure>
                    <div class="card-body">
            ...
            <dialog id="my_modal_1" class="modal">
                <form method="dialog" class="modal-box max-w-[50%]">
                    <div class="flex justify-around items-center">
                        <img class="w-56" src=" {{ url('uploads/book_images/Introduction-to-Algorithms.jpg') }} "
                            alt="Intro to Algorithms" /></figure>
                        <div class="card-body">

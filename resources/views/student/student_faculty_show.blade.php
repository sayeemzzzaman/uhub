        ...
        <div class="grid grid-cols-5 gap-12 m-1">
            ...
            @foreach ($contacts as $contact)
                ...
                <dialog id="mod{{ $contact->id }}" class="modal">
                    <form method="POST" action=" {{ route('student.counselling.quickRequeCounselling') }}"
                        class="modal-box max-w-[50%]">
                        @csrf
                        <div class="flex justify-around items-center">
                            ...
                            <div class="card-body">
                                ...
                                <input name="faculty" type="text" value="{{ $contact->name }}" hidden>
                                
                                <div class="form-control w-full max-w-xs">
                                    <label class="label">
                                        <span class="label-text">Select time for counseling</span>
                                    </label>
                                    <select name="timeing" class="select select-bordered">
